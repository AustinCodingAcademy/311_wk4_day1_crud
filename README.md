...
update usersAddress set address = 'REDACTED' where address like 'OH'

3. All three DELETES

* DELETE from usersContact

delete from usersContact where user_id like '114';

* DELETE from usersAddress

delete from usersAddress where user_id like '114';

* DELETE from users

delete from users where user_id like '114';
