...
* INSERT INTO users(first_name, last_name) values ('Lance','Hammond'), ('Scott','Summers')
...
*   DELETE FROM usersContact WHERE user_id = 500;

* DELETE from usersAddress

*   DELETE FROM usersAddress WHERE user_id = 500;
