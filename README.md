...
1. INSERT two users: INSERT INTO users (first_name, last_name)
   VALUES ('test', 'user'); ^ ^ test2 user

    <!-- RESOURCE TO KEEP: https://www.freecodecamp.org/news/sql-insert-and-insert-into-statements-with-example-syntax/ -->
